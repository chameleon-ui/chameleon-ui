      ...
      return {
        ...
        value: expandLiteral(
          ...
          index === lastPseudoLiteralIndex
            ? countGraphemes(element.value) + Math.max(
                0,
                minimumLiteralLength - pseudoPoundLength - pseudoElements.reduce(
                  (total, candidate) =>
 ...
 * The English text never replaces the pseudo glyphs; it only sets the target.
 *
