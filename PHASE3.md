...
看板此前已有勾选与命令，但仍缺红线 / 明确未做 / 合入检查专节，且其它阶段未链到 PHASE5–9，相对 PHASE5+ 偏薄。本次按 P5+ 骨架补齐章节。**未翻 DoD**：T3.3 计时、T3.7 盲测→P9、T3.10 接口说明书、R1–R3→P9 仍为 `[ ]`；T3.8 VPAT 草稿仍为 `[x]`（P4 落盘）。**这是文档同步，不是重新验收或重关 M3。** Owner 一律 **待指定**。未补缺件，未 git commit。
