...
for (const id of themeIds) {
  const cssPath = require.resolve(`@chameleon-ui/themes/dist/${id}/variables.css`)
  overlays[id] = await readFile(cssPath, 'utf8')
}
const overlaysTs = `/* Generated by scripts/collect-public.mjs — do not edit. */
export const themeOverlays = ${JSON.stringify(overlays, null, 2)} as const
`
await writeFile(join(here, '..', 'src', 'theme-overlays.generated.ts'), overlaysTs, 'utf8')
