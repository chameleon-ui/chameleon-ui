...
>
> **现状（2026-08-13）**：8 套官方致敬主题已由项目所有者确认无法律问题（非律所意见书），以免费官方主题出货。市场允许社区付费。  
...
| 主题 IP | 禁商标/官方图标/专有字体；代号命名；官方 8 套已所有者确认（2026-08-13），免费出货 |
...
合并 → 主干
发版 → 发版门禁（性能+RTL；官方 8 套主题已所有者确认）→ npm/Registry/Docs
可选 → 遥测聚合 → GenUI-Bench
```
